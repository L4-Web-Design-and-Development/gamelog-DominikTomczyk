  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <div className="flex flex-col bg-[url(assets/png/hero-image.png)] bg-no-repeat bg-center w-[1368px] h-[697px] justify-between p-24">
        <p className="text-[80px]/[100px] font-bold w-[550px]">Track Your <span className="bg-gradient-to-r from-cyan-300 to-cyan-600 text-transparent bg-clip-text">Gaming</span> Journey with Ease</p>
